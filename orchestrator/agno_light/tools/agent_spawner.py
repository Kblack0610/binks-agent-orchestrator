"""
Agent Spawner Tool - Agno Implementation
Spawns worker agents as Kubernetes Jobs
"""
import os
import subprocess
import tempfile
...
class AgentSpawnerToolkit(Toolkit):
    """Toolkit for spawning worker agents as Kubernetes Jobs."""

    def __init__(self):
        super().__init__(name="agent_spawner_toolkit")
    ...
    def spawn_worker_agent(
        ...
        try:
            ...
            template_path = f"../../../manifests/k8s-manifests/agents/{agent_type}-job.yaml"
    ...
    def check_agent_status(self, job_name: str, namespace: str = "ai-agents") -> str:
        """
