...
impl AdbMcpServer {
    ...
    #[tool(description = "Capture a screenshot from an Android device. By default returns JPEG at quality 80, resized to fit within 1024x1920 pixels (25-50x smaller than raw PNG). Supports optional cropping and PNG output. Returns base64-encoded image or saves to file.")]
