...
//! # Access Modes
//!
//! By default, only read-only tools are available. Enable the `readwrite`
//! feature to expose tools that create or modify Linear data:
//! - `readwrite` - Enables issue creation, starting, and commenting
...
// ============================================================================
// Read-Write Tools (requires "readwrite" feature)
// ============================================================================
...
impl LinearCliMcpServer {
    pub fn new() -> Self {
        ...
        #[cfg(feature = "readwrite")]
        let router = router + Self::write_tool_router();
